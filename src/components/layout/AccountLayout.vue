<template>
    <div class="list">
        <div class="left-form" style="margin: 10px;float:left;">
            <div style="">
                <i class="iconfont icon-yemian-copy" style="display: inline-block;float: left;"></i>
        ...
        <div class="right-list">
            <div class="search" style="padding: 18px 10px 0 10px; margin-bottom:10px;background-color: #fff">
